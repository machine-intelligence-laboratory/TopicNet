...
setup(
  ...
  packages = ['topicnet', 'topicnet.cooking_machine', 'topicnet.viewers'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/machine-intelligence-laboratory/TopicNet/archive/v0.1.tar.gz',    # I explain this later on
