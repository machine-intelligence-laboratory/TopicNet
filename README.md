...
<p>
    ...
    <em>
        ...
        At the first stage, regularizer with parameter <img src="https://latex.codecogs.com/svg.latex?\tau"> taking values in some range <img src="https://render.githubusercontent.com/render/math?math=\{\tau_1, \tau_2, \tau_3\}"> is applied.
